<template>
    ...
    <q-page class="wedding-page column flex flex-center">
        <!-- Hero Section -->
        <div class="hero q-pa-sm column flex flex-center">
        ...
        <q-card flat bordered class="upload-card q-mt-xl q-pa-md">
            ...
            <q-card-section class="text-center">
                <q-btn color="pink-6" text-color="white" label="Избери слики" icon="photo_camera"
                    @click="selectFiles" />
            ...
            <q-card-section v-if="previews.length">
                <div class="row q-col-gutter-md justify-center">
                    <div v-for="(src, index) in previews" :key="index"
                        class="col-4 q-mb-md relative-position preview-img" :class="{ dimmed: index >= 20 }">
