<template>
    <div class="q-pa-md gallery-wrapper">
        ...
        <div v-else class="grid-container">
            <div v-for="(img, index) in images" :key="index" class="image-box" @click="openDialog(img)">
        ...
        <q-dialog v-model="showDialog" persistent maximized>
            <q-card class="bg-pink-2">
                <q-card-section class="q-pa-none full-img-container">
                    <img :src="selectedImage" class="full-img" />
                </q-card-section>

                <q-card-actions align="center">
                    <q-btn flat color="white" label="Затвори" @click="showDialog = false" />
                    <q-btn flat color="white" icon="download" label="Преземи" @click="downloadImage(selectedImage)" />
                </q-card-actions>
            </q-card>
        </q-dialog>
